    ...
    <section className="relative w-full py-24 px-4 sm:px-8 lg:px-12 xl:px-16 bg-[#F4F7F4] overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl">
        ...
        <motion.div
          ...
          className="mx-auto max-w-3xl text-center flex flex-col items-center gap-4 mb-16"
        >
          {/* Badge */}
        ...
        <motion.div
          ...
          className="relative grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-8"
        >
          ...
          {steps.map((item, idx) => {
            ...
            return (
              <motion.div
                ...
                className="group relative z-10 flex flex-col rounded-3xl bg-white p-7 sm:p-8 shadow-md shadow-emerald-950/5 ring-1 ring-emerald-900/10 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl hover:shadow-emerald-950/15"
              >
        ...
        <motion.div
          ...
          className="mt-16 rounded-3xl bg-gradient-to-r from-emerald-900 via-emerald-850 to-emerald-950 p-8 sm:p-10 text-white shadow-2xl shadow-emerald-950/20 relative overflow-hidden"
        >
